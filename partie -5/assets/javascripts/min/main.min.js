...
;!function(i,t){"use strict";var r;r=function(){function i(i){this.selector=i.selector,this.id_img=0,this.nbr_img=t("img[data-src]").length,this.initierChargement()}return i.prototype={initierChargement:function(){var i=t("img[data-src]:eq("+this.id_img+")");i.load(t.proxy(this.chargerSuivant,this)).error(t.proxy(this.chargerSuivant,this)).attr({src:i.data("src")}),this.id_img++},chargerSuivant:function(i){console.log("chargerSuivant",i),this.id_img<this.nbr_img&&this.initierChargement()}},i}(),i.loaderImg=r}(window,jQuery);
;var scroll_top;$(function(){function t(){r[a-1]&&r[a-1].actif?($(".btn-g p").text(r[a-1].episode),$(".btn-g").data("lien",r[a-1].lien),$(".btn-g").data("titre",r[a-1].titre)):$(".btn-g").css({display:"none"}),r[a+1]&&r[a+1].actif?($(".btn-d p").text(r[a+1].episode),$(".btn-d").data("lien",r[a+1].lien),$(".btn-d").data("titre",r[a+1].titre)):$(".btn-d").css({display:"none"}),$(".btn-d, .btn-g").bind("click",function(){var t=$(this).data("lien");window.location.href=t}),$(".btn-d, .btn-g, .btn-vignette, .btn-carte").hover(function(){if($(".mc2").velocity("stop").velocity({opacity:.5,duration:800}),$(".tooltip").stop(),$(".tooltip").removeClass("gauche").removeClass("droit").removeClass("posY"),$(".tooltip p").html($(this).data("titre")),"g"==$(this).data("p"))$(".tooltip").css({opacity:"1",display:"block","margin-left":"0"}).addClass("gauche");else if("d"==$(this).data("p"))$(".tooltip").css({opacity:"1",display:"block","margin-left":"0"}).addClass("droit");else{var t=$(this).offset().left-$(".tooltip").width()/2;$(".tooltip").css({opacity:"1",display:"block","margin-left":t}).addClass("posY")}$(".tooltip").css({display:"block"})},function(){$(".tooltip").stop().fadeOut(300),$(".mc2").velocity("stop").velocity({opacity:1,duration:800},{delay:200})});for(var t=0;o>t;t++)$(".vignettes .mc").append('<div class="vignette"><div class="image"></div><div class="grad"></div><div class="txt"><h2></h2><p></p></div></div>');for(var t in r)r[t].actif&&($(".vignettes .mc .vignette").eq(t).children(".txt").children("h2").html(r[t].date),$(".vignettes .mc .vignette").eq(t).children(".txt").children("p").html(r[t].titre),$(".vignettes .mc .vignette").eq(t).children(".image").append('<img src="'+r[t].url_vignette+'" width="288" height="288" alt=""/>'),$(".vignettes .mc .vignette").eq(t).css({cursor:"pointer"}),$(".vignettes .mc .vignette").eq(t).data("lien",r[t].lien),$(".vignettes .mc .vignette").eq(t).bind("click",function(){var t=$(this).data("lien");window.location.href=t}))}function i(){n=window.innerWidth,c=window.innerHeight,$(".full-h").css({height:c}),$(".full-h2").css({height:1.5*c});var t=10*((n-30*n/100)/(308*o)).toFixed(1);$(".vignettes .mc").css({width:308*t}),$(".mc2 header").css({height:$(".mc2 header video").height()}),$(window).trigger("scroll")}function e(){$(window).scrollTop(),window.innerHeight}$("body").css({"background-color":"#000","overflow-x":"hidden"}),$("footer").css({"z-index":300});var o,n=window.innerWidth,c=window.innerHeight,s=$($.browser.webkit?"body":"html"),a=4,r=[];$("#ge_ed .effet-blur").effetBlur(),$("#ge_ed .parallaxe").parallaxe(),$("#ge_ed .effet-volet").effetVolet(),$("#ge_ed .navigation").nav();var l="/mmpub/xml/flash/navigation.json";$.getJSON(l,function(i){$.each(i.dates,function(t,i){r.push(i)}),o=i.nbre_dates,t()}),$(".btn-vignette, .btn-carte").bind("click",function(){$(".tooltip").css({display:"none"}),$(".mc2").css({opacity:1}),scroll_top=$(window).scrollTop();var t=$(window).scrollTop();$(".wraper-container").css({position:"fixed",overflow:"hidden",width:$("#ge_ed").width(),height:c}),$(".wraper-container .mc").css({top:-t}),$(".cacher").css({display:"block"}),"carte"==$(this).data("type")?$(".cacher .mask .mc .carte").css({display:"block"}):"vignette"==$(this).data("type")&&$(".cacher .mask .mc .vignettes").css({display:"block"}),$(window).scrollTop(0),$(".wraper-container").velocity("stop").velocity({top:-c},{duration:1e3,complete:function(){$(".wraper-container").css({display:"none"})}})}),$(".cacher .mask .mc .fermer").bind("click",function(){$(".wraper-container").css({display:"block",width:n}).velocity("stop").velocity({top:0},{duration:1e3,complete:function(){$(".wraper-container").css({position:"relative",height:$(".wraper-container .mc").height()}),$(".cacher, .cacher .mask .mc .carte, .cacher .mask .mc .vignettes").css({display:"none"}),$(".wraper-container .mc").css({top:0}),$(window).scrollTop(scroll_top)}})}),$(window).resize(function(){i()}),$(window).load(function(){i()}),i(),$(".to_top").bind("click",function(){$(s).velocity("stop").velocity("scroll",{duration:4e3,offset:0,easing:"easeInOutSine"})}),$(window).scroll(function(){e()}),$(".mc2 header video").bind("click",function(){$(s).velocity("stop").velocity("scroll",{duration:1e3,offset:$(".container").offset().top,easing:"easeInOutSine"})})}),$.fn.effetBlur=function(){this.each(function(){var t=$(this),i=$(this).parent().parent();return $(this).css({opacity:0}),$(window).scroll(function(){var e=$(window).scrollTop(),o=(i.offset().top,e/(window.innerHeight/2.5));"fixed"!=$(".wraper-container").css("position")&&t.css({opacity:o})}),$(window).resize(function(){}),this})},$.fn.effetVolet=function(){this.each(function(){var t,i,e=$(this),o=$(this).children(".mask"),n=window.innerWidth,c=$(this).data("coefl")?$(this).data("coefl"):1;return $(window).scroll(function(){e.css({height:o.height()});var s=$(window).scrollTop(),a=window.innerHeight,r=e.offset().top+e.height()-a,l=e.offset().top+e.height();if("fixed"!=$(".wraper-container").css("position"))o.children("img").css({position:"relative",top:0}),s>=r&&l>s?(e.css({width:n}),o.css({position:"fixed",width:"inherit",top:a-o.height()})):(e.css({width:n*c}),o.css({position:"relative",width:"inherit",top:0})),t=e.offset().top,i=o.position().top;else{var d="fixed"==o.css("position")?scroll_top-t+i:0;o.css({position:"relative",width:"inherit",top:0}),o.children("img").css({position:"relative",top:d})}}),$(window).resize(function(){n=window.innerWidth,$(window).trigger("scroll")}),this})},$.fn.nav=function(){this.each(function(){var t=$(this),i=!1;return $(window).scroll(function(){var e=$(window).scrollTop(),o=window.innerHeight/3;e>=o&&!i?(i=!0,t.velocity("stop").velocity({top:35,duration:1e3},{complete:function(){}})):o>e&&i&&(i=!1,t.velocity("stop").velocity({top:-35,duration:1e3},{complete:function(){}}))}),$(window).resize(function(){$(window).trigger("scroll")}),this})};
