...
;var scroll_top;$(function(){function t(){a[r-1]&&a[r-1].actif?($(".btn-g p").text(a[r-1].date),$(".btn-g").data("lien",a[r-1].lien),$(".btn-g").data("titre",a[r-1].titre)):$(".btn-g").css({display:"none"}),a[r+1]&&a[r+1].actif?($(".btn-d p").text(a[r+1].date),$(".btn-d").data("lien",a[r+1].lien),$(".btn-d").data("titre",a[r+1].titre)):$(".btn-d").css({display:"none"}),$(".btn-d, .btn-g").bind("click",function(){var t=$(this).data("lien");window.location.href=t}),$(".btn-d, .btn-g").hover(function(){$(".tooltip").stop(),$(".tooltip").removeClass("gauche").removeClass("droit"),$(".tooltip p").html($(this).data("titre")),"g"==$(this).data("p")?$(".tooltip").css({opacity:"1",display:"block"}).addClass("gauche"):"d"==$(this).data("p")&&$(".tooltip").css({opacity:"1",display:"block"}).addClass("droit"),$(".tooltip").css({display:"block"})},function(){$(".tooltip").stop().fadeOut(300)});for(var t=0;n>t;t++)$(".vignettes .mc").append('<div class="vignette"><div class="image"></div><div class="grad"></div><div class="txt"><h2></h2><p></p></div></div>');for(var t in a)a[t].actif&&($(".vignettes .mc .vignette").eq(t).children(".txt").children("h2").html(a[t].date),$(".vignettes .mc .vignette").eq(t).children(".txt").children("p").html(a[t].titre),$(".vignettes .mc .vignette").eq(t).children(".image").append('<img src="'+a[t].url_vignette+'" width="288" height="288" alt=""/>'),$(".vignettes .mc .vignette").eq(t).css({cursor:"pointer"}),$(".vignettes .mc .vignette").eq(t).data("lien",a[t].lien),$(".vignettes .mc .vignette").eq(t).bind("click",function(){var t=$(this).data("lien");window.location.href=t}))}function i(){o=window.innerWidth,c=window.innerHeight,$(".full-h").css({height:c}),$(".full-h2").css({height:1.5*c});var t=10*((o-30*o/100)/(308*n)).toFixed(1);$(".vignettes .mc").css({width:308*t}),$(window).trigger("scroll")}function e(){$(window).scrollTop(),window.innerHeight}$("body").css({"background-color":"#000","overflow-x":"hidden"});var n,o=window.innerWidth,c=window.innerHeight,s=$($.browser.webkit?"body":"html"),r=1,a=[];$("#ge_ed .effet-blur").effetBlur(),$("#ge_ed .parallaxe").parallaxe(),$("#ge_ed .effet-volet").effetVolet(),$("#ge_ed .navigation").nav();var l="/mmpub/xml/flash/navigation.json";$.getJSON(l,function(i){$.each(i.dates,function(t,i){a.push(i)}),n=i.nbre_dates,t()}),$(".btn-vignette, .btn-carte").bind("click",function(){scroll_top=$(window).scrollTop();var t=$(window).scrollTop();$(".wraper-container").css({position:"fixed",overflow:"hidden",width:$("#ge_ed").width(),height:c}),$(".wraper-container .mc").css({top:-t}),$(".cacher").css({display:"block"}),"carte"==$(this).data("type")?$(".cacher .mask .mc .carte").css({display:"block"}):"vignette"==$(this).data("type")&&$(".cacher .mask .mc .vignettes").css({display:"block"}),$(window).scrollTop(0),$(".wraper-container").velocity("stop").velocity({top:-c},{duration:1e3,complete:function(){$(".wraper-container").css({display:"none"})}})}),$(".cacher .mask .mc .fermer").bind("click",function(){$(".wraper-container").css({display:"block",width:o}).velocity("stop").velocity({top:0},{duration:1e3,complete:function(){$(".wraper-container").css({position:"relative",height:$(".wraper-container .mc").height()}),$(".cacher, .cacher .mask .mc .carte, .cacher .mask .mc .vignettes").css({display:"none"}),$(".wraper-container .mc").css({top:0}),$(window).scrollTop(scroll_top)}})}),$(window).resize(function(){i()}),$(window).load(function(){i()}),i(),$(".to_top").bind("click",function(){$(s).velocity("stop").velocity("scroll",{duration:4e3,offset:0,easing:"easeInOutSine"})}),$(window).scroll(function(){e()})}),$.fn.effetBlur=function(){this.each(function(){var t=$(this),i=$(this).parent().parent();return $(this).css({opacity:0}),$(window).scroll(function(){var e=$(window).scrollTop(),n=(i.offset().top,e/(window.innerHeight/2.5));"fixed"!=$(".wraper-container").css("position")&&t.css({opacity:n})}),$(window).resize(function(){}),this})},$.fn.effetVolet=function(){this.each(function(){var t,i,e=$(this),n=$(this).children(".mask"),o=window.innerWidth,c=$(this).data("coefl")?$(this).data("coefl"):1;return $(window).scroll(function(){e.css({height:n.height()});var s=$(window).scrollTop(),r=window.innerHeight,a=e.offset().top+e.height()-r,l=e.offset().top+e.height();if("fixed"!=$(".wraper-container").css("position"))n.children("img").css({position:"relative",top:0}),s>=a&&l>s?(e.css({width:o}),n.css({position:"fixed",width:"inherit",top:r-n.height()})):(e.css({width:o*c}),n.css({position:"relative",width:"inherit",top:0})),t=e.offset().top,i=n.position().top;else{var d="fixed"==n.css("position")?scroll_top-t+i:0;n.css({position:"relative",width:"inherit",top:0}),n.children("img").css({position:"relative",top:d})}}),$(window).resize(function(){o=window.innerWidth,$(window).trigger("scroll")}),this})},$.fn.nav=function(){this.each(function(){var t=$(this),i=!1;return $(window).scroll(function(){var e=$(window).scrollTop(),n=window.innerHeight/3;e>=n&&!i?(i=!0,t.velocity("stop").velocity({top:35,duration:1e3},{complete:function(){}})):n>e&&i&&(i=!1,t.velocity("stop").velocity({top:-35,duration:1e3},{complete:function(){}}))}),$(window).resize(function(){$(window).trigger("scroll")}),this})};
